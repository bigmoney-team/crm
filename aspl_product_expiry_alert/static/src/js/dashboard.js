odoo.define('aspl_product_expiry_alert.dashboard', function (require) {
    "use strict";
    ...
    var ProductExpiryDashboard = AbstractAction.extend(ControlPanelMixin, {
        ...
        location_expire: function(result){
            ...
            self.do_action({
                   ...
                   target: 'new',
                   domain:[['state_check','=','near_expired'],['location_id','=',parseInt(result)]],
            });
        },
           ...
           .then(function(records){
               ...
               var userList = new List('warehouse', options, values);
                   ...
                   for(var data=0;data<records['category_near_expire'].length;data++){
                        ...
                        html += "<span class='info-box-icon bg-aqua categ_click' id='expire_in_60_days' style='cursor:pointer;background:#"+category_color[data]+";'>"+records['category_near_expire'][data]['qty']+"</span>";
